...
public class GameBoardPanel extends JPanel {
    ...
    public GameBoardPanel() {
        ...
        // Cells (JTextFields)
        CellInputListener listener = new CellInputListener(); // typing or pressing enter interactions
        ...
        } // if cell is editable it will call for the cellinputlistener to handle actions generated by player 
    ...
    /* If he ask to add another difficulty
    public void CustomDifficulty() {
    // Get a new Puzzle with your custom difficulty level
    puzzle.newPuzzle(customDifficultyLevel);
    ...
    private class CellInputListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
             ...
             * sourceCell.number. Update the cell status sourceCell.status, and re-paint
             * the cell via sourceCell.paint().
             */
